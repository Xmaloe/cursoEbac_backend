...
function _toArray2(arr) { return _arrayWithHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableRest(); }
...
function somarComRest() {
  ...
  var numeros = [1, 2, 3, 4];
  (_console2 = console).log.apply(_console2, _toConsumableArray(numeros));
  //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  ...
  var carroDaAna = _objectSpread2(_objectSpread2({}, carroDaJulia), {}, {
    motor: 1.8
  });
  console.log(carroDaAna);
  ...
  var _timesDeFutebol2 = timesDeFutebol,
    _timesDeFutebol3 = _toArray2(_timesDeFutebol2),
    item1 = _timesDeFutebol3[0],
    item2 = _timesDeFutebol3[1],
    item3 = _timesDeFutebol3[2],
    outrosTimes = _timesDeFutebol3.slice(3);
  console.log(item1);
  console.log(item2);
  console.log(item3);
  console.log(outrosTimes);
