...
const colegas = ['Karen', 'Isabella', 'Vicente']; //array de strings
const tecnologias = ['html', 'javascript', 'css']; //array de strings
const notas = [7, 9, 11, 13]; //marcado como somente leitura, não pode modificar os elementos do array
...
const lista = ['Karen', true, 22]; // Tupla
let minhaIdade = 22; // uso do any
minhaIdade = 22;
minhaIdade = '22 anos';
minhaIdade = true;
let Dados; //any= qualquer tipo
Dados = 10;
Dados = 'string';
Dados = true;
Dados = [1, 2, 3];
